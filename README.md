...
###Обучение моделей
Для этого проекта я выбрал 7 моделей: ..... , после сбора данных можно приступать к обучению, для большей ефективности обучения я использовал optuna для подбора наилучших параметров моделей, ефективность модели определялось процентной разницей между предсказанной ценой акции и фактической
